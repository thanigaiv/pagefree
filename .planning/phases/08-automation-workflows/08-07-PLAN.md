...
3. Group workflow events by executionId

4. Render WorkflowTimelineEntry for grouped events

5. Keep existing non-workflow events as-is
...
4. Add breadcrumbs for workflow pages
  ...
  <verify>cd frontend && npx tsc --noEmit</verify>
  <done>Workflow timeline shows in incident detail, routes registered in App</done>
</task>
