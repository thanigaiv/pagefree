...
Import and use the hooks from useServices.ts at the top of the component:
- Import useServices, useCreateService, useUpdateService, useUpdateServiceStatus from '@/hooks/useServices'
- Import useTeams from '@/hooks/useTeams' for the team filter dropdown
- Import Service, ServiceStatus, CreateServiceInput, UpdateServiceInput types from '@/types/service'
...
Verify route registration by checking the compiled output includes ServicesPage:
Run: `grep -l "ServicesPage" frontend/src/App.tsx`
Verify: Returns frontend/src/App.tsx (confirms import exists)

Run: `grep "admin/services" frontend/src/App.tsx`
Verify: Returns line containing the route registration
  </verify>
  <done>
